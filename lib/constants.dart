...
const String kDepartmentNullError = "학과를 입력해주세요";
const String kLongDepartmentError = "학과 이름 길이가 너무 깁니다";
const String kHeightNullError = "키를 입력해주세요";
const String kLongHeightError = "유효한 키를 입력해주세요";
const String kHobbyNullError = "취미를 입력해주세요";
const String kLongHobbyError = "취미를 30자 이내로 입력해주세요";
const String kIntroduceNullError = "자기소개를 입력해주세요";
const String kLongIntroduceError = "자기소개를 30자 이내로 입력해주세요";
