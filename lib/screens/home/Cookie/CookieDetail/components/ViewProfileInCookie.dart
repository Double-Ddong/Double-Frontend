...
var dio = Dio();
class ViewProfileInCookie extends StatefulWidget {
  @override
  _ViewProfileInCookie createState() => _ViewProfileInCookie();
}

class _ViewProfileInCookie extends State<ViewProfileInCookie> {
